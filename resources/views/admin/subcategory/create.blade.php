...
@section('content')
    <div class="page-header">
        ...
        <div>
            <a href="{{ route('admin.subcategory.index') }}" class="btn btn-primary">Back to List</a>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.subcategory.store') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="category_id" class="form-label">Category<strong class="text-danger">*</strong></label>
