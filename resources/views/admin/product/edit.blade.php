                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="short_description" name="short_description"
                                        rows="4">{{ $product->short_description ?? old('short_description') }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="price" name="price"
                                                value="{{ $product->price ?? old('price') }}" min="0">
                                            @error('price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="quantity" name="quantity"
                                                value="{{ $product->quantity ?? old('quantity') }}" min="0">
                                            @error('quantity')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="discount" name="discount"
                                                value="{{ $product->discount ?? old('discount') }}" min="0">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="discount_price"
                                                name="discount_price"
                                                value="{{ $product->discount_price ?? old('discount_price') }}" min="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="subCategory" id="subCategory" class="form-select">
                                        ...
                                        @forelse($subCategories as $subCategory)
                                            <option @selected($subCategory->id == $product->sub_category_id)
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check pb-1">
                                        <input class="form-check-input" @checked($product->is_featured == true) type="radio" name="is_featured" id="yes" value="1">
                                        <label class="form-check-label" for="yes">Yes</label>
                                    </div>
                                    <div class="form-check pt-1">
                                        <input class="form-check-input" @checked($product->is_featured == false) type="radio" name="is_featured" id="no" value="0">
                                ...
                                <div class="mb-3">
                                    <label>Status:</label>
                                    <div class="form-check pb-1">
                                        <input class="form-check-input" @checked($product->status == true) type="radio" name="status" id="published" value="1">
                                        <label class="form-check-label" for="published">Published</label>
                                    </div>
                                    <div class="form-check pt-1">
                                        <input class="form-check-input" @checked($product->status == false) type="radio" name="status" id="draft" value="0">
